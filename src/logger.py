...
class JsonLogFormatter(logging.Formatter):
    ...
    STANDARD_FIELDS = {
        ...
        'stack_info', 'msg', 'args', 'msecs', 'relativeCreated',
...
def log_structured(level: int, message: str, **kwargs):
    ...
    Usage:
        log_structured(logging.INFO, 'Scan completed', repo_url='https://...', leaks=5)
    """
...
if LOG_LEVEL == logging.DEBUG:
    logger.debug(f'Logger initialized with level: {LOG_LEVEL_STR}, console level: {CONSOLE_LOG_LEVEL_STR}, json_format: {LOG_JSON_FORMAT}')
