...
{css_content}
    ...
    def get_executive_summary_cards(self, data: Dict[str, Any]) -> str:
        ...
        detection_accuracy = (
            round((data.get("successful_scans", 0) / data.get("total_leaks", 1) * 100), 1)
            if data.get("total_leaks", 0) > 0
            else 0
        )
    ...
    def get_risk_assessment_section(self, data: Dict[str, Any]) -> str:
        ...
        for item in data.get("category_breakdown", []):
            ...
            severity_color = (
                "text-red-600"
                if avg_severity >= 2.5
                else ("text-yellow-600" if avg_severity >= 1.5 else "text-green-600")
            )
    ...
    def get_monthly_trends_section(self, data: Dict[str, Any]) -> str:
        ...
        section = """<div class='bg-white rounded-3xl shadow-2xl p-8 fade-in-up' style='animation-delay: 0.3s'>
    ...
    def get_status_distribution_section(self, data: Dict[str, Any]) -> str:
        ...
        section = """<div class='bg-white rounded-3xl shadow-2xl p-8 fade-in-up' style='animation-delay: 0.4s'>
        ...
        status_names = {"4": "Ошибка", "success": "Успешно", "error": "Сбой", "pending": "В процессе"}
        status_colors = {
    ...
    def get_platform_analysis_section(self, data: Dict[str, Any]) -> str:
        ...
        section = """<div class='bg-white rounded-3xl shadow-2xl p-8 fade-in-up' style='animation-delay: 0.45s'>
    ...
    def get_company_breakdown_section(self, data: Dict[str, Any]) -> str:
        ...
        section = """<div class='bg-white rounded-3xl shadow-2xl p-8 fade-in-up' style='animation-delay: 0.5s'>
        ...
        for company, total, resolved, pending in data.get("company_breakdown", []):
            ...
            efficiency_color = (
                "text-green-600" if efficiency >= 80 else ("text-yellow-600" if efficiency >= 60 else "text-red-600")
            )
    ...
    def get_leak_types_section(self, data: Dict[str, Any]) -> str:
        ...
        section = """<div class='bg-white rounded-3xl shadow-2xl p-8 fade-in-up' style='animation-delay: 0.6s'>
        ...
        if detection_patterns:
            ...
            for pattern in detection_patterns:
                ...
                confidence_color = (
                    "text-green-600"
                    if confidence >= 90
                    else ("text-yellow-600" if confidence >= 70 else "text-red-600")
                )
    ...
    def generate_html(self, data: Dict[str, Any], start_date: str, end_date: str, report_type: str = "business") -> str:
        ...
        report_title = "Бизнес-отчет" if report_type == "business" else "Технический отчет"
