...
def test_graphql_search():
    ...
    try:
        ...
        if data and 'data' in data:
            ...
            logger.info(f"✅ GraphQL search successful!")
            ...
            logger.error(f"❌ GraphQL returned errors:")
...
def test_graphql_repo_stats():
    ...
    try:
        ...
        if data and 'data' in data and 'repository' in data['data']:
            ...
            logger.info(f"✅ Repository stats retrieved successfully!")
            ...
            logger.warning(f"⚠️  Repository stats query failed (may need additional permissions)")
            return False
